...
BWD_DIFF_TABLE: dict[str, BwdDiffEntry] = {
    ...
    # M-AG5.1 Tier-2 (2026-05-29): ``softplus_fwd`` now declares
    # ``no_diff float beta, no_diff float threshold`` parameters, so
    # ``aten.softplus_backward`` is routed through BWD_DIFF_TABLE.
    "aten.softplus_backward": BwdDiffEntry(
        "softplus_fwd",
        "pointwise",
        1,
        no_diff_params=("beta", "threshold"),
    ),
