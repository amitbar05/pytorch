...
from .dispatch_call import CallKernelMixin
...
class HeaderMixin(CallKernelMixin):
    """Mixin providing body assembly, shader codegen, and dispatch-call codegen.

    ``call_kernel`` lives in :class:`CallKernelMixin` (`dispatch_call.py`)
    to keep this file under the 800-line anti-goal #7 cap.
    """
