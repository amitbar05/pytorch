...
def _register_activation_autograd_pyimpl() -> None:
    ...
    M15.2 audit (b): workaround for ReluBackward0 meta cascade. The C1
    pre-grad pass (_replace_relu_with_clamp_min) may have made this
    redundant. Candidate for (c) after testing. See M15.2.c.
    """
