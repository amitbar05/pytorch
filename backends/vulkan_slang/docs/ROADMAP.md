...
| **CG.2** | **bf16 packed16 fallback store missing `_packed16_vw_active` guard** (`kernel/pointwise.py:718-736`): structural conflict — bf16 fallback set `_pw_has_wave_ops` unconditionally, but vector-write rewrite had already eliminated wave ops. | ✅ **CLOSED 2026-06-22** — guard added at pointwise.py:725, test: TestBf16PackedStoreWave32 |
