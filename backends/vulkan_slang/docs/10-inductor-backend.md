...
>
**Last updated: 2026-05-23 (session: M19.3 horizontal fusion wiring — `_coalesce_orphan_pointwise` installed as `_post_fusion_custom_pass`; `TestM193HorizontalFusion` added)**
