...
| # | Title | Status |
|---|-------|--------|
| **M22.1.a-g** | Split file-size violators | `conv.py` ✅ M22b; `rnn.py` ✅ M22d (700 L); `wrapper.py` ✅ M22.1.h (642 L + `wrapper_helpers.py` 254 L); `scheduling.py` ✅ M22c (781 L + `scheduling_helpers.py` 134 L); `runtime/slangc.py` M22a **Stage 1 ✅ 2026-05-22** (2342→2030L, `common.py` 374L) + **Stage 2 ✅ 2026-05-23** (2030→1376L, `shader_lib.py` 776L). Remaining 1376L needs Stages 3–7 to reach ≤800L target. Commits `975748a916e`, `78bd544240d`. |
